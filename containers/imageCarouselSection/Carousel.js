/**
 * Image Carousel (overhaul of react-native-slider)
 * @author Edmary Rosado (special thanks to leecade<leecade@163.com> for the original Slider)
 */
...
export default class ImageCarousel extends Component {
  ...
  renderPagination = () => {
    ...
    const ActiveDot = this.props.activeDot || <View style={[{
      backgroundColor: this.props.activeDotColor || '#40beeb',
      width: 15,
      height: 15,
      borderRadius: 7.5,
      marginLeft: 7.5,
